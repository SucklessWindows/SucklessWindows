...
@REM reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\10" /v "Title" /t REG_SZ /d "SucklessWindows" /f >NUL 2>nul
@REM reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\10" /v "URL" /t REG_SZ /d "https://github.com/SucklessWindows" /f >NUL 2>nul
